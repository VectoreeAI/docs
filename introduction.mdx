---
title: "Overview"
description: "Backend for your agent today. A public URL and a way to charge users — launching soon."
---
...
Vectoree Cloud takes an agent from a local project to something other people can use — and pay you for.

Today you connect a project and give the agent a backend: **Model Gateway**, **Tool Hub**, **Auth**, **Database**, and **Storage**, plus an organization wallet you top up for model and tool usage. Agents operate it with a **Skill + CLI**; web search and extract go through hosted MCP.

The same project then gets a public URL ([Deploy](/deploy)) and a way for those people to pay you ([Payments](/payments)). Both are in development and launching soon.

## The path

Connect a project, attach the backend, publish it, then charge the people who use it.
